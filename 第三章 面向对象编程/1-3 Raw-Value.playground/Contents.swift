...
if let theMonth = Month(rawValue: input){
    print("\(monthsBeforeNewYear(month: theMonth)) months before New Year!")
}
...
let myFavoriteLanguage2: ProgrammingLanguage2 = .ObjectiveC
